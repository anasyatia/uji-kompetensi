...
class PenjualanController extends Controller
{
    ...
    public function dashboardAdmin()
    {
        ...
        $memberCount = Penjualan::whereNotNull('member_id')->count();
        $nonMemberCount = Penjualan::whereNull('member_id')->count();
        ...
        $productSales = DB::table('detail_penjualans')
            ...
            $remainingStock = Produk::select('produk as name', 'stok as total_stock')
            ->get()
            ->map(function ($item) {
                $item->total_stock = (int) $item->total_stock;
                return $item;
            });

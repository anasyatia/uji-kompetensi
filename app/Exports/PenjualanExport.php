...
class PenjualanExport implements FromCollection, WithHeadings
{
    public function collection()
    {
        ...
        foreach ($penjualans as $item) {
            ...
            $totalAfterDiscount = $item->total_harga;
            $kembalian = $item->total_bayar - $totalAfterDiscount;
